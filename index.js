...
console.log(createMenuItem("Turkey Sandwich", 12, "Lunch"));
console.log(createMenuItem("Bacon Egg Biscuit", 5, "Breakfast"));
console.log(createMenuItem("Chicken Alfredo", 18, "Dinner"));
...
reviews.push({name: "Zack", rating: 5, feedback:"Fantastic food, atmosphere, and service!"})
